...
and returns the full list transparently to callers.
"""
...
def fetch_all_nodes(
    ...
    """Fetch all graph nodes with pagination, returning at most max_items (default 2000). Each page request includes retry logic."""
    all_nodes: list[Any] = []
