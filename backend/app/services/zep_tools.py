...
2. PanoramaSearch (breadth search) - Retrieves the full picture, including expired content
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries along with a synthesized analysis.
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out garbage content containing question numbers (e.g. "Question 1-9" in Chinese)
                skip = False
                for d in '123456789':
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interviews (interview simulated Agents, gather multi-perspective insights)

    [Basic Tools]
    - search_graph - Graph semantic search
    - get_all_nodes - Get all graph nodes
    - get_all_edges - Get all graph edges (including temporal info)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges in the graph (paginated, including temporal info)
    ...
    def get_simulation_context(
        ...
        # Filter entities with real types (exclude pure Entity nodes)
        entities = []
        for node in all_nodes:
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function; auto-decomposes the query and retrieves across multiple dimensions:
        1. Use LLM to break the query into sub-queries
        ...
        Args:
            ...
            query: User query
            simulation_requirement: Simulation requirement description
            report_context: Report context (optional; improves sub-query precision)
    ...
    def _generate_sub_queries(
        ...
        Breaks a complex query into multiple independently retrievable sub-queries.
        """
        system_prompt = """You are a professional query analysis expert. Your task is to break down a complex question into multiple sub-questions that can be independently observed in the simulated world.
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Retrieves the most complete panoramic information, including expired content:
        1. Get all graph nodes
        2. Get all graph edges (with timestamps)
        3. Sort by query relevance
        4. Separate currently active facts from historical facts
        ...
        for edge in all_edges:
            ...
            # Populate source/target node names for each edge
    ...
    def interview_agents(
        ...
        [Important] This feature requires the simulation environment to be running (OASIS environment must be active)
        ...
        - Need to obtain real responses from simulated Agents (not LLM simulation)
        ...
        try:
            # Build batch interview list (no platform specified; both platforms)
            interviews_request = []
            ...
            api_result = SimulationRunner.interview_agents_batch(
                ...
                timeout=180.0   # both platforms require a longer timeout
            )
            ...
            # Dual-platform mode response format: {"twitter_0": {...}, "reddit_0": {...}, "twitter_1": {...}, ...}
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Always include dual-platform labels
                ...
                clean_text = re.sub(r'问题\d+[：:]\s*', '', clean_text)  # 问题 = "Question" (legacy Chinese label)
                ...
                meaningful = [
                    ...
                    and not s.strip().startswith(('{', '问题'))  # 问题 = "Question" (legacy Chinese label)
                ]
                ...
                interview = AgentInterview(
                    ...
                    agent_bio=agent_bio[:1000],  # extend bio length limit
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Strip JSON tool-call wrapping from Agent responses and extract actual content"""
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                - selected_agents: Full info list for selected Agents
                - selected_indices: Index list for selected Agents (for API calls)
...
Please select up to {max_agents} Agents best suited for the interview, and explain your selection rationale."""
...
Please generate 3-5 interview questions."""
        ...
        try:
            ...
            return [
                ...
                "What impact has this had on you or the group you represent?",
...
2. Identify consensus and divergences among viewpoints
