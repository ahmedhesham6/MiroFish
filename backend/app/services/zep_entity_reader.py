...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: Function to execute (a parameterless lambda or callable)
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all nodes of a graph (paginated retrieval)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all edges of a graph (paginated retrieval)
    ...
    def filter_defined_entities(
        ...
        - If a node's labels include labels other than "Entity" and "Node", it matches a predefined type and is kept
