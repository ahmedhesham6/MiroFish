...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform and batch-sends to Zep after accumulating BATCH_SIZE activities per platform.
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Per-platform activity buffer (each platform accumulates up to BATCH_SIZE before batch sending)
    ...
    def _worker_loop(self):
        """Background worker loop - batch-sends activities to Zep grouped by platform"""
