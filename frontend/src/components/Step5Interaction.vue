        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state; leverages Global/Local Memory for deep cross-temporal attribution analysis</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface with optimized index efficiency for rapid extraction of node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer that conducts parallel multi-turn dialogues with simulation individuals, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to explore report content in depth' : 'Chat with a simulated individual to learn their perspective' }}
              </p>
            </div>
            <div 
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert the object dictionary to an array, preferring reddit platform replies
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      ...
      // Legacy array format compatibility
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Convert the object dictionary to array format
...
/* Fix ordered list numbering - use CSS counters so multiple ol elements number consecutively */
.message-text {
...
/* Quote styles for chat/questionnaire areas */
