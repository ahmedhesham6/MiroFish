    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">millions of Agents</span> from the seeds of reality within it. By injecting variables from a god's-eye view, it searches for the <span class="highlight-code">"local optimum"</span> in dynamic environments through complex group interactions.
            </p>
            <p class="slogan-text">
              Let the future play out in Agent swarms — let decisions emerge victorious after countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">~$5/run for typical simulations</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">Scalable</div>
              <div class="metric-label">Up to millions of Agents per simulation</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & persona generation & environment config Agent injects simulation params</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction requirements & dynamic timeline memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g. If Wuhan University issues an announcement revoking the disciplinary action against Xiao, what public sentiment trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to Process page (special "new" marker indicates a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk is used as the primary heading font; JetBrains Mono for code/label font.
