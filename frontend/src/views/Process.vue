<template>
  <div class="process-page">
    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph build will start automatically after generation completes</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-hint">Data loading soon...</p>
          </div>
      ...
      <!-- Right panel: Build pipeline details -->
...
const goToNextStep = () => {
  // TODO: navigate to env setup step
...
const renderGraph = () => {
  ...
  // Draw edges (with transparent wide clickable area)
