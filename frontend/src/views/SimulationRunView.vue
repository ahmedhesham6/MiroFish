...
// Read maxRounds from query params at init time so child components receive the value immediately
...
const loadGraph = async (graphId) => {
  // When simulating, skip full-screen loading on auto-refresh to avoid flickering
...
const startGraphRefresh = () => {
  ...
  addLog('Started graph auto-refresh (30s interval)')
...
onMounted(() => {
  ...
  // Log maxRounds config (value was already read from query params during init)
  if (maxRounds.value) {
